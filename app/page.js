    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="text-center mb-16">
          <a href="https://ai-mockup.vercel.app/" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300" role="alert">
            <span className="text-xs bg-primary rounded-full text-white px-4 py-1.5 mr-3">New</span>
            <span className="text-sm font-medium">404-AI-Mock-Interview</span>
